...
#if LJ_ABI_ARM64EC
#define RSET_PLATFORM	(RSET_RANGE(RID_X13,RID_X14+1)|RID2RSET(RID_X18)|\
			 RSET_RANGE(RID_X23,RID_X24+1)|RID2RSET(RID_X28))
#else
#define RSET_PLATFORM	RID2RSET(RID_X18)
#endif
#define RSET_FIXED \
  (RSET_PLATFORM|RID2RSET(RID_FP)|RID2RSET(RID_LR)|RID2RSET(RID_SP)|\
   RID2RSET(RID_GL))
...
#define RSET_SCRATCH_GPR	(RSET_RANGE(RID_X0, RID_X17+1) &~ RSET_PLATFORM)
#define RSET_SCRATCH_FPR \
  (RSET_RANGE(RID_D0, RID_D7+1)|RSET_RANGE(RID_D16, RID_MAX_FPR))
